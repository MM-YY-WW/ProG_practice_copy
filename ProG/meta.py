...
def clone_module(module, memo=None):
    ...
    creates a copy of a module, whose parameters/bufferse/submodules are created using PyTorch's torch.clone()
    ...
    if memo is None:
            ...
            for param_key in module._parameters:
                if module._parameters[param_key] is not None:
                    ...
                    if param_ptr in memo:
                        ...
                        cloned = param.clone()
                        clone._paramters[param_key] = cloned
        ...
        #Finaly, rebuild the falttented parameters for RNNS
...
class MAML(BaseLearner):
    ...
    def adapt(self, loss, first_order=None, allow_unused = None, allow_nograd = None):
        ...
        if allow_nograd:
            ...
            grad_params = grad(loss, diff_params, retrain_graph=second_order, create_graph = second_order, allow_unused = allow_unused)
            gradients = []
            grad_counter = 0
    ...
    def clone(self, first_order = None, allow_unused = None, allow_nograd=None):
        ...
        return MAML(clone_module(self.module),
                    lr = self.lr, first_order = first_order, allow_unused=allow_unused, allow_nograd = allow_nograd)