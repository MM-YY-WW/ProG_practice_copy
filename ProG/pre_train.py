...
from .utils import gen_ran_output, load_data4pretrian, mkdir, graph_views
...
class PreTrain(torch.nn.Module):
    def __init__(self, pretext="GraphCL", gnn_type='TransformerConv',
        ...
        self.gnn = GNN(input_dim = input_dim, hid_dim = hid_dim, gcn_layer_num=gln, pool=None,
                       gnn_type = gnn_type)
    ...
    def get_loader(self, graph_list, batch_size,
        ...
        if len(graph_list) % batch_size == 1:
            raise KeyError("batch_size {} makes the last batch only contain 1 graph, \n which will trigger a zero bug in GraphCL!")
        ...
        for epoch in range(1, epochs + 1):
            ...
            if train_loss_min > train_loss:
                ...
                torch.save(self.model.gnn.state_dict(),
                           "./pre_trained_gn/{}.{}.{}.pth".format(dataname, self.pretext, self.gnn_type))
